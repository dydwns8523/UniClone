...
public class PlayerStats : NetworkBehaviour
{
    ...
    void HealthDown(float h)
    {
        ...
        if (HealthValue < 0)
        {
            ...
            GameDirector.Instance.nonPlayerCamera.GetComponent<DeadCamera>().deadScreen.SetActive(true);
            GameDirector.Instance.nonPlayerCamera.GetComponent<DeadCamera>().deadRank.text
                = GameDirector.Instance.players.Count.ToString() + " 등";
